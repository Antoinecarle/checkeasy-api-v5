#!/usr/bin/env python3
"""
Script de test pour vérifier les logs en production
Utilise un payload valide basé sur le modèle EtapesAnalysisInput
"""
import requests
import json
import time
...
def monitor_logs():
    ...
    for i in range(60):  # Vérifier pendant 60 secondes
        try:
...
def test_analyze_complete():
    """Lance une requête /analyze-complete avec un payload valide"""
    print("🚀 Lancement d'une requête /analyze-complete...\n")
    
    # Payload valide basé sur EtapesAnalysisInput
    test_payload = {
...
if __name__ == "__main__":
    print("=" * 60)
    print("🧪 TEST DES LOGS EN PRODUCTION")
    print("=" * 60)
